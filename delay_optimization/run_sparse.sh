#!/usr/bin/env bash
# Generate a SPARSE Gdansk network and run delay optimization sweep.
#
# Sparse variant: low link survival, few edges per node.
...
#   ./delay_optimization/run_sparse.sh --seeds 2 -j 2    # Quick test
