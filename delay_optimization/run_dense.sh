...
#
# Prerequisites:
#   1. MeshCore fork at ../MeshCore-dense (or set MESHCORE_DIR)
...
BUILD_DIR="$PROJECT_DIR/build-native-fork-dense"
MESHCORE_PATH="${MESHCORE_DIR:-$PROJECT_DIR/../MeshCore-dense}"
